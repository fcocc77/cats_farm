...
remove_files = ["Makefile", "Makefile.Debug", "Makefile.Release",
                ".qmake.stash", "object_script.monitor.Debug", "object_script.monitor.Release"]
...
if platform == "win32":
    ...
    os.system("cd " + dirname + " && " + qmake +
              " " + project + " > %temp%/null")
    os.system("set path=" + os.path.dirname(make) + "; && cd " +
              dirname + " && " + make + " > %temp%/null")
    ...
    os.system("cd " + dirname +
              " && source /opt/rh/devtoolset-7/enable && make > /dev/null")
