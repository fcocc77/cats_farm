...
void submit::init(int argc, char const *argv[])
{
    ...
    QString arg, jobName, server, serverGroup, firstFrame, lastFrame, taskSize,
        priority, suspend, comment, software, project, extra, system, instances,
        render, ip;
