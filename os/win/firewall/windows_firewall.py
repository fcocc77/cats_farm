	...
	if apps:
		for name, app in apps:
			for direction in ["in","out"]:
				...
				rule='netsh advfirewall firewall add rule name="'+name+'" dir='+direction+' action='+action+appss+' enable=yes  profile='+profile+' protocol='+protocol+localports
...
firewall(action="block", program="C:/Program Files (x86)/Common Files/Microsoft Shared")
...
firewall(action="block", program="C:/Program Files/Nuke10.5v4")
...
firewall(name="CatsFarm", action="allow",protocol="TCP", localport="7773,7774")
